            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-[#fff] rounded-lg shadow-sm p-5 flex flex-col h-full">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <div className="text-sm font-semibold text-[#44343E] mb-1">
                      Employees
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-[#fff] rounded-lg shadow-sm p-5">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-[#44343E]">
                    Recent Employee Activity
                  </h3>
                  <button
                    className="text-sm text-indigo-600 hover:text-indigo-500"
                    onClick={openRecentActivityModal}
                  >
                    View All
                  </button>
                </div>
        ...
        <div className="flex items-center justify-between mb-2">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Track performance, analyze trends, and get actionable insights
            </p>
          </div>
          <DateRangePicker
...
const AdminDashboard = () => {
  ...
  return (
    <div
      className="flex h-screen bg-[#fff]"
    ...
    >
      ...
      >
        ...
        <main
          className="flex-1 overflow-y-auto bg-[#fef4f3] p-1"
          style={{ fontFamily: "Montserrat, sans-serif" }}
        >
